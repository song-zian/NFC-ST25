...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_Pin | ST25_LPD_Pin | INK_MOSI_Pin | INK_CLK_Pin | INK_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PAPin PAPin PAPin PAPin
                           PAPin */
  GPIO_InitStruct.Pin = LED_Pin | ST25_LPD_Pin | INK_MOSI_Pin | INK_CLK_Pin | INK_CS_Pin;
