...
#define rfalLogE(...)             printf(__VA_ARGS__)        /*!< Macro for the error log method                  */
#define rfalLogW(...)             printf(__VA_ARGS__)        /*!< Macro for the warning log method                */
#define rfalLogI(...)             printf(__VA_ARGS__)        /*!< Macro for the info log method                   */
#define rfalLogD(...)             printf(__VA_ARGS__)        /*!< Macro for the debug log method                  */
